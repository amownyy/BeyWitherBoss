package works.emregumus.beywitherboss.Api.Utils;
...
public class AdventureUtils {
    ...
    public static void consoleMessage(String s) {
        if (s == null) return;
        Audience au = BeyWitherBoss.getAdventure().sender(Bukkit.getConsoleSender());
    ...
    public static void playerMessage(Player player, String s) {
        if (s == null) return;
        Audience au = BeyWitherBoss.getAdventure().player(player);
        au.sendMessage(getComponentFromMiniMessage(s));
    }
